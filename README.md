...
<a href="https://ivanpetrovic.dev/visual-comparison/"><img src="docs/images/allure-overview.png" width="820" alt="Allure dashboard — visual regressions caught, categorized as Product defects, with trend history"/></a>
<br/><sub>The live <b><a href="https://ivanpetrovic.dev/visual-comparison/">Allure dashboard</a></b> — the with-bugs run: every visual regression caught, grouped as <i>Product defects</i>, with a pass-rate trend across runs.</sub>

<table>
  <tr>
    <td align="center" width="50%"><img src="docs/images/allure-detail.png" alt="Failed test detail with the mismatch reason"/><br/><sub>Each failure shows <b>why</b> — the pixel mismatch (<code>ratio of all image pixels different</code>), every step, and its attachments.</sub></td>
    <td align="center" width="50%"><img src="docs/images/allure-diff.png" alt="Allure image-diff viewer — Show diff / Show overlay"/><br/><sub>…and the <b>image diff</b> itself — <i>Show diff / Show overlay</i> over Expected vs Actual.</sub></td>
  </tr>
</table>
